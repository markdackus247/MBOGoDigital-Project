...
<div class="max-w-sm w-full lg:max-w-full lg:flex mb-8">
    <div class="border border-gray-200 h-auto w-1/2 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden">
        <img src="/images/pythonchallenge/python_challenge_5.png" alt="Achterliggend leerdoel Challenge 27">
    </div>
    <div
        ...
        <div class="mb-8">
            ...
            <div class="text-gray-900 font-bold text-xl mb-2">Ik kan het spel snake maken met pygame.
            </div>
