...
<div class="w-full  max-w-sm w-full lg:max-w-full lg:flex mb-8">
    <div class="border border-gray-300 h-auto w-1/2 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden">
        <img src="/images/pythonchallenge/python_challenge_8.png" alt="Achterliggend leerdoel Challenge 27">
    </div>
    <div
        ...
        <div class="mb-8">
            ...
            <div class="text-gray-900 font-bold text-xl mb-2">Ik kan bij het maken van een applicatie gebruik maken van design patterns
            </div>
