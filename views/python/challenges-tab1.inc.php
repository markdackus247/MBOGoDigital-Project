...
<div class="max-w-sm w-full lg:max-w-full lg:flex mb-8">
    ...
    <div class="w-full border border-gray-200 bg-white rounded-b p-4 flex flex-col justify-between leading-normal">
        <div class="mb-8">
            <p class="text-sm text-gray-600 flex items-center italic mt-2 mb-8">
                Challenge 1
            </p>
            <div class="text-gray-900 font-bold text-xl mb-2">Ik kan eenvoudige computerprogramma's maken met de
                scripttaal Python zonder gebruik te maken van ChatGPT.</div>
...
<p class="text-gray-900 text-lg m-4 mb-8">
    Hieronder staan ongeveer 30 kleine computerprogamma's die je helpen om te leren programmeren met Python. Eerst
    installeer je Python en PyCharm Community op je eigen computer. Daarna kies je zelf kleine challenges uit de lijst
    hier beneden. Probeer zowel individueel en als groep zoveel mogelijk punten bijelkaar te verzamelen. Personen die
    chatGPT (of ander AI-programma) om deze mini-challenges op te lossen worden gediskwalificeert. Je mag natuurlijk wel
    zaken op internet opzoeken.
</p>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="border border-gray-300 px-4 py-2"><b>Roulette</b><br />
                ...
                <b>Winst:</b> Als het getal van de speler overeenkomt met het gedraaide getal, wint de speler 35 keer
                zijn inzet.<br />
                <b>Doorgaan:</b> De speler kan kiezen om door te gaan of te stoppen.<br />
                Dit programma helpt studenten om te oefenen met loops, conditionals, en de random module in Python. Veel
                plezier met het spelen en leren! Heb je nog andere vragen of opdrachten waar je hulp bij nodig hebt?
            </td>
            <td class="border border-gray-300 px-4 py-2 font-bold text-center"></td>
            <td class="border border-gray-300 px-4 py-2 font-bold text-center">4</td>
            <td class="border border-gray-300 px-4 py-2 font-bold text-center">80</td>
        ...
        <tr>
            ...
            <td class="border border-gray-300 px-4 py-2"><b>Minecraft JSON</b><br />De blokken in Minecraft kunnen we
                beschrijven met een JSON object. Dit object bevat dan de specifieke eigenschappen van het blok. In deze
                opdracht gaan we deze eigenschappen aanpassen. Als eerste willen we een grasblok in een sneeuwblok laten
                veranderen. Hiervoor moet je 'snow' op 'True' zetten. Vervolgens willen we de locatie van het blok
        ...
        <tr>
            ...
            <td class="border border-gray-300 px-4 py-2"><b>Nachtjes slapen</b><br />In deze opdracht ga je een
                programma schrijven om voor een datum te berekenen hoeveel dagen geleden het deze datum was, of hoeveel
                dagen deze datum in de toekomst ligt. Bijvoorbeeld: +48 dagen is 48 dagen in de toekomst en -12 dagen is
