...
<table class="table-auto w-full border-collapse border border-gray-400 mb-8">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="border border-gray-300 px-4 py-2"><b>Roulette</b><br />Zoek uit wat de Bubble Sort methode is en maak een programma waarin je deze methode toepast.</td>
            <td class="border border-gray-300 px-4 py-2 font-bold text-center"></td>
            <td class="border border-gray-300 px-4 py-2 font-bold text-center">4</td>
            <td class="border border-gray-300 px-4 py-2 font-bold text-center">80</td>
        </tr>
