...
<div class="max-w-sm w-full lg:max-w-full lg:flex mb-8">
    ...
    <div
        ...
        <div class="mb-8">
            ...
            <div class="text-gray-900 font-bold text-xl mb-2">Ik kan unittests schrijven voor mijn python code.
            </div>
...
<p class="text-gray-900 text-lg m-4 mb-8">
    Clone repository <a href="https://github.com/markdackus247/python_unittest_mbo.git"
        class="underline">python_unittest_mbo van de github repository markdackus247</a>. Het programma laat gebruikers
    cijfers invullen en berekent het gemiddelde van deze cijfers. Om te voorkomen dat gebruikers foute invoer geven zijn
    er allerlei functie toegevoegd om de invoer te controleren. Schrijf unittests voor alle functies in het programma.
    Zorg ervoor dat je de unittests in een apart bestand plaatst en dat je de unittests kunt uitvoeren met behulp van de
    unittest module van python.
</p>
...
<table class="table-auto w-full border-collapse border border-gray-400 mb-8">
    ...
    <tbody>
        <tr>
            ...
            <td class="border border-gray-300 px-4 py-2"><b>unittest</b><br />Ik kan unittests schrijven voor mijn
                python code.</td>
        ...
        <tr>
            ...
            <td class="border border-gray-300 px-4 py-2"><b>unittest met classes</b><br />Ik kan de bestaande code
                herschrijven naar OOP en pas de unittests aan.</td>
            <td class="border border-gray-300 px-4 py-2 font-bold text-center"><img width="100px"
            src="/images/pythonchallenge/badges/king_of_testing.jpg" alt="BADGE: The King of Testing"></td>
